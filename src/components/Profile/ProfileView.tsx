...
import {
    User, MapPin, Heart, Link, GraduationCap, Book, Edit, AlertCircle,
    Github, Twitter, Linkedin, Facebook, Instagram, Globe
} from 'lucide-react';
        ...
        return (
            <div className="w-full max-w-5xl mx-auto px-4 py-8">
                <Alert className="animate-in fade-in-50">
                    ...
                    <AlertDescription>No profile data is available. Create your profile to get started.</AlertDescription>
            ...
            <Card className="overflow-hidden border-none shadow-lg">
                ...
                <div className="h-32 bg-gradient-to-r from-primary/90 via-primary/70 to-primary/50 relative">
                    <div className="absolute bottom-0 right-0 p-4">
                        <Button variant="ghost" size="icon" className="bg-background/50 backdrop-blur-sm hover:bg-background/70 rounded-full">
                            <Edit size={18} />
                        </Button>
                    </div>
                </div>
                            ...
                            <div className="p-4 bg-background border rounded-lg shadow-sm">
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-lg">{getCompletionStatusEmoji(completionPercentage)}</span>
                                    </div>
                                    <Badge variant={completionPercentage === 100 ? "default" : "outline"} className="font-semibold">
                        ...
                        <Card className="shadow-sm">
                            ...
                            <CardContent className="pt-2">
                                        ...
                                        <div className="bg-muted/40 rounded-lg p-4 border">
                                            {profile.bio ? (
                                                ...
                                                <div className="text-center py-4">
                                                    <p className="text-muted-foreground mb-2">No bio provided</p>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="bg-muted/40 rounded-lg p-4 border">
                                            {profile.description ? (
                                                ...
                                                <div className="text-center py-4">
                                                    <p className="text-muted-foreground mb-2">No description provided</p>
                                                    <Button variant="outline" size="sm">
                                ...
                                <TabsContent value="skills" className="mt-0 space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        <h3 className="text-base font-medium flex items-center gap-2">
                                            <GraduationCap size={16} className="text-primary" /> Current Skills
                                        </h3>
                                            ...
                                            {profile?.user.skills && profile.user.skills.length > 0 ? (
                                                ...
                                                <div className="h-full flex items-center justify-center p-4">
                                                    <div className="text-center">
                                                        <p className="text-muted-foreground mb-2">No skills added</p>
                                                        <Button variant="outline" size="sm">
                                                            <GraduationCap size={14} className="mr-2" /> Add skills
                                                        </Button>
                                                    </div>
                                                </div>
                                            )}
                                    ...
                                    <div className="space-y-3">
                                        <h3 className="text-base font-medium flex items-center gap-2">
                                            <Book size={16} className="text-primary" /> Skills I Want to Learn
                                        </h3>

                                        <ScrollArea className="h-52 rounded-lg border">
                                            {profile?.user.desiredSkills && profile.user.desiredSkills.length > 0 ? (
                                                <div className="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                ...
                                                <div className="h-full flex items-center justify-center p-4">
                                                    <div className="text-center">
                                                        <p className="text-muted-foreground mb-2">No desired skills added</p>
                                                        <Button variant="outline" size="sm">
                                                            <Book size={14} className="mr-2" /> Add desired skills
                                                        </Button>
                                                    </div>
                                                </div>
                                            )}
